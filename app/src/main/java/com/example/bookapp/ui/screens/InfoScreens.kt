...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(Modifier.height(4.dp))
            Text(
                "پشتیبان کامل شامل یادداشت‌ها، علاقه‌مندی‌ها، پاورقی‌ها، نقش‌های «من»، گفتگوها و فایل‌های واقعی تصاویر و صداست. " +
                    "ارجاع‌های داخلی با مسیر معنایی ذخیره می‌شوند تا روی نصب تازه هم درست بازیابی شوند. " +
                    "می‌توانید حافظه/کارت یا سرویس ابری را انتخاب کنید و در صورت نیاز فایل را با رمزگذاری AES-GCM ذخیره کنید. " +
                    "اگر رمز را فراموش کنید، بازیابی فایل رمزگذاری‌شده ممکن نیست.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            Spacer(Modifier.height(12.dp))
